...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center">
      <a href="<?= BASE_URL ?>/sales" class="btn btn-link btn-sm mr-2"><i class="fas fa-calendar-day mr-1" aria-hidden="true"></i> Ventas del día</a>
      <form class="form-inline mr-2" method="get" action="<?= BASE_URL ?>/sales/all">
